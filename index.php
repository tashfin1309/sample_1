...
<section class="headline">
    ...
    <h1 class="head1">"X" International School And College Information Portal</h1>

</section>

<section class="home">

         <div class="wrapper" style="background:url(images/image2.jpg) no-repeat"></div>
...
<section class="register">
    ...
    <h1 class="head1">Register Here</h1>
